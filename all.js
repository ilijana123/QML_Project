...
Object.extend(Resource.prototype, {
  ...
  authenticityToken: function() {
    return this.element.down("input[name=authenticity_token]").value;
  },
  ...
  request: function(method, options) {
    ...
    options = Object.extend(options, {
      method: method,
      parameters: Object.extend(params, { authenticity_token: this.authenticityToken() }),
...
var Todos = {
  ...
  makeNotDraggable: function(id) {
    Sortable.destroy($('incomplete_items'));
  },
